...
out_data_path = '/oak/stanford/groups/jamesz/zqwu/iPSC_data/linear_aligned_patches/cross_11-to-14/'
if not os.path.exists(out_data_path):
    os.mkdir(out_data_path)
gen.cross_pair_save(time_interval=[11, 14], seed=123, save_path=out_data_path)