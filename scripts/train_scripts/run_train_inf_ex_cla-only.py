...
from layers import load_partial_weights, fill_first_layer, evaluate_confusion_mat, evaluate_confusion_mat_classify_only
...
train_gen = PairGenerator(
    name_file,
    X_filenames,
    segment_y_files=None, #y_filenames,
    segment_w_files=None, #w_filenames,
...
model.fit(train_gen,
          ...
          verbose=2,
          n_epochs=200)
model.save(os.path.join(MODEL_DIR, 'resnet_ex_0-to-inf_0.model'))
