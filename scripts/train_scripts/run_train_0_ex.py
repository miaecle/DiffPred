...
### Settings ###
ROOT_DIR = '/oak/stanford/groups/jamesz/zqwu/iPSC_data/TRAIN/0-to-0_continuous/'
VALID_DIR = '/oak/stanford/groups/jamesz/zqwu/iPSC_data/TRAIN/0-to-0_continuous/l1ex15_valid/'
TEST_DIR1 = '/oak/stanford/groups/jamesz/zqwu/iPSC_data/TRAIN/0-to-0_continuous/l1ex7_valid/'
TEST_DIR2 = '/oak/stanford/groups/jamesz/zqwu/iPSC_data/TRAIN/0-to-0_continuous/l3ex4_valid/'
SPLIT_FILE = '/oak/stanford/groups/jamesz/zqwu/iPSC_data/TRAIN/ex_split.pkl'

MODEL_DIR = '/oak/stanford/groups/jamesz/zqwu/iPSC_data/model_save/ex_split/0-to-0_ex/'
...
test_inds1 = [i for i, n in names.items() if well_info(n) in test_wells1]
test_inds2 = [i for i, n in names.items() if well_info(n) in test_wells2]
...
model.fit(train_gen,
          ...
          n_epochs=200,
          verbose=2)
model.save(os.path.join(MODEL_DIR, 'pspnet_ex_0-to-0_0.model'))
