...
from data_loader import load_image_pair, get_all_files, get_ex_day, get_well
from segment_support import preprocess, assemble_for_training, generate_fluorescence_labels
...
def load_assemble_test_data(data_path, dataset_path):
    ...
    print("Number of input images: %d" % len(fs_pair), flush=True)
